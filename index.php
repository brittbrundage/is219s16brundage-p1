...
<head>
    ...
    <meta name="description" content="">
      <meta name="author" content="Brittani Brundage">

    <title>Brittani Brundage</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Brittani Brundage</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="img/njit.png" alt="">
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="img/experience.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Campus Activities</h2>
                    <p class="lead">Sigma Psi Kappa Sorority <br>
                    University Heights, Newark, NJ <br>
                    April 2012 - Present
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="img/sigma.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Brittani Brundage 2016. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
